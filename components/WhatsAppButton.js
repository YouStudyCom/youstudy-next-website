...
export default function WhatsAppButton() {
    const phoneNumber = "442036082800";
    ...
    return (
        ...
        >
            <div className="relative">
                ...
                {/* Tooltip */}
                <span className="absolute right-full mr-3 top-1/2 transform -translate-y-1/2 bg-gray-800 text-white text-xs py-1 px-3 rounded opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap">
                    Chat with us
                </span>
            </div>
        </Link>
