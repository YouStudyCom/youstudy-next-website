...
export const cleanHtml = (html) => {
    ...
    // Remove empty tags (paragraphs, headings, bold, strong, etc.)
    // Matches tags containing only whitespace, &nbsp;, or <br>
    processed = processed.replace(/<(p|h[1-6]|strong|b|i|em|span|div)[^>]*>(\s|&nbsp;|<br\/?>)*<\/\1>/gi, '');
